...
variable "public_subnet_1_map_public_ip" {
  description = "Whether to auto-assign public IP on launch for subnet 1"
  type        = bool
  default     = true
}
...
variable "public_subnet_2_map_public_ip" {
  description = "Whether to auto-assign public IP on launch for subnet 2"
  type        = bool
  default     = true
}
...
variable "container_memory_mb" {
  description = "Memory (MB) assigned to the container"
  type        = number
  default     = 512
}
