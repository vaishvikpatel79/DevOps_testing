...
resource "aws_security_group_rule" "alb_egress_all_to_vpc" {
  type              = "egress"
  from_port         = 0
  to_port           = 0
  protocol          = "-1"
...
resource "aws_ecr_repository" "ecr_repo_fastapi_demo" {
...
resource "aws_cloudwatch_log_group" "ecs_log_group" {
  name = "/ecs/${var.project_name}-${var.environment}-fastapi-demo-service"
