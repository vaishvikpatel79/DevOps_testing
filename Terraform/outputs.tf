...
output "ecs_cluster_name" {
  ...
  value       = aws_ecs_cluster.fastapi_demo_ecs_cluster.name
}
...
output "ecr_image_uri_fastapi_demo_service" {
  description = "Constructed ECR image URI for fastapi-demo-service"
...
output "security_group_ids" {
  description = "List of security group IDs (ALB and ECS)"
...
output "deployment_contract" {
  ...
  value = {
    ...
    compute = {
      cluster_name  = aws_ecs_cluster.fastapi_demo_ecs_cluster.name
